 ...
 * @property {boolean} [valid]         Whether ADC produced a usable token (legacy).
 * @property {boolean} [ok]            Whether the credential is usable (new standard).
 * @property {?string} [email]         Principal email if resolvable, else null (legacy).
 * @property {?string} [principal]     Principal email if resolvable, else null (new standard).
